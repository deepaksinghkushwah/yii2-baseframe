            ...
            if ($model->validate()) {
                if ($model->save()) { // if user saved       
                    ...
                    if ($profile->validate()) {
                        ...
                        $roles = $_REQUEST['Userprofile']['roles'];
                        //echo "<pre>";print_r($_REQUEST);exit;
                        // reovok all roles and permissions from user
                        \app\components\GeneralHelper::revokeUserRoles($id);
                        ...
                        return $this->redirect(['/backend/user/update','id' => $id]);
                    } else {

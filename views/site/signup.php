...
<div class="site-signup">
    ...
    <div class="row">
        <div class="col-lg-5">
            ...
            <?= $form->field($profile, 'address_line2')->textInput() ?>
            <?= $form->field($profile, 'country_id')->dropDownList(yii\helpers\ArrayHelper::map(\app\models\GeoCountry::find()->all(),'id','name'),['prompt' => 'Select Any']) ?>
            <?= $form->field($profile, 'state_id')->dropDownList([],['prompt' => 'Select Any']) ?>
            <?= $form->field($profile, 'city_id')->dropDownList([],['prompt' => 'Select Any']) ?>
